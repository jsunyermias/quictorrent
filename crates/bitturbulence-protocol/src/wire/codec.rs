...
mod tests {
    ...
    #[test]
    fn keepalive() {
        assert_eq!(rt(Message::KeepAlive), Message::KeepAlive);
    }
    #[test]
    fn have_piece() {
        assert_eq!(
    ...
    fn partial() {
        ...
        let mut b = BytesMut::from(&b"\x00\x00\x00"[..]);
        assert!(c.decode(&mut b).unwrap().is_none());
    }
    #[test]
    fn too_large() {
        let mut c = MessageCodec;
        let mut b = BytesMut::new();
        b.put_u32((MAX_FRAME_SIZE + 1) as u32);
